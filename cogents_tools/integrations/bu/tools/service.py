...
from cogents_tools.integrations.bu.agent.views import ActionModel, ActionResult
from cogents_tools.integrations.bu.browser import BrowserSession
from cogents_tools.integrations.bu.browser.events import (
    ClickElementEvent,
    CloseTabEvent,
...
""".strip()
        ...
        async def select_dropdown_option(params: SelectDropdownOptionAction, browser_session: BrowserSession):
            ...
            from cogents_tools.integrations.bu.browser.events import SelectDropdownOptionEvent
