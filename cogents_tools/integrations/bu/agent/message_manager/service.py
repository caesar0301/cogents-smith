...
from cogents_tools.integrations.bu.agent.message_manager.views import HistoryItem
from cogents_tools.integrations.bu.agent.prompts import AgentMessagePrompt
...
def _log_format_message_line(
    message: BaseMessage, content: str, is_last_message: bool, terminal_width: int
) -> list[str]:
