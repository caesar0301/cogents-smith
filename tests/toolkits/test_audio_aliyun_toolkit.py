...
from cogents_tools.toolkits.audio_aliyun_toolkit import AudioAliyunToolkit
...
class TestAudioAliyunToolkit:
    ...
    @patch("cogents_tools.toolkits.audio_aliyun_toolkit.AudioAliyunToolkit._transcribe_file_aliyun")
