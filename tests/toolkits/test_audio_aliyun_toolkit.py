...
from cogents_smith.toolkits.audio_aliyun_toolkit import AudioAliyunToolkit
...
class TestAudioAliyunToolkit:
    ...
    @patch("cogents_smith.toolkits.audio_aliyun_toolkit.AudioAliyunToolkit._transcribe_file_aliyun")
    ...
    @patch("cogents_smith.toolkits.audio_aliyun_toolkit.AudioAliyunToolkit.transcribe_audio")
